...
const RefineSearch = () => {
  ...
  const handleCheckbox = (name: string) => {
    setFilters((previous) => ({
      ...previous,
      [name]: !previous[name as keyof typeof previous],
    }));
  };
  ...
  const handleApplyFilter = () => {
    ...
    if (filters.security) {
      params.set("security", "true");
    }

    if (filters.swimmingPool) {
      params.set("swimmingPool", "true");
    }

    if (filters.airConditioning) {
      params.set("airConditioning", "true");
    }

    if (filters.verifiedProperty) {
      params.set("verifiedProperty", "true");
    }
  ...
  return (
    ...
    >
      ...
      <div className="mb-5 flex items-center justify-between gap-3">
        ...
        <h2 className="text-lg font-semibold text-[#2E2E2E] sm:text-xl">
          Refine Search
        </h2>
